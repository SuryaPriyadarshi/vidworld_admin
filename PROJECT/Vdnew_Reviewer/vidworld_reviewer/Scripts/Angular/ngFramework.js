...
var app = angular.module('myApp', ['ngTable', 'ngSanitize', 'ui.bootstrap', 'ngCookies', 'ngHashtags', 'oitozero.ngSweetAlert', 'ngGuid']);
...
//var baseUrl = 'http://54.210.240.64:1337/';  // Dev url
//var baseUrl = 'http://18.204.255.20:1336/';  // QA url
var baseUrl = 'https://vid.world:1337/';  // QA url
var EndPoint = {    
    Admin: baseUrl
};
...
app.factory("myFactory", function ($http, $log, $filter, ngTableParams, appConstant, $window, $cookieStore) {
    ...
    return {
        ...
        putDataForLogout: function (EndPoint, method, onSuccess, onError) {
            LoaderStart(); //Loader Stop on your success method  
            //var accessToken = "";
            //    //constants.accessToken;
            $http({
...
app.factory("SweetAlert", function ($rootScope) {
...
app.controller('appctrl', function ($rootScope, $scope, $http, myFactory, appConstant, $window, $cookieStore, $sce, $timeout, SweetAlert, $filter, Guid, $cookies) {
